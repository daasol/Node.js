...
//mongoose에 대한 설정이 이루어지므로, userSchema에 이것을 전달해야함
function connectDB(){
...
//user_schema 모듈에 존재하는 함수를 불러옴 ...
function createUserSchema(database) {
    //database의 속성으로 UserSchema를 추가함
    ...
    */
     ...
     database.UserModel = mongoose.model('user2', database.UserSchema);
